...
var DogComponent = /** @class */ (function () {
    ...
    DogComponent.prototype.getADog = function () {
        var _this = this;
        this.http.get('https://random.dog/woof.json?filter=mp4,webm').subscribe(function (data) { _this.results = data['url']; });
    };
